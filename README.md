...
```bash
/usr/local/Cellar/git/2.29.1/share/git-core/contrib/diff-highlight/diff-highlight
```

The segment of the above path that matters is `2.29.1` as this is the version of git you are using locally.
