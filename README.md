...
```bash
/usr/local/Cellar/git/2.28.0/share/git-core/contrib/diff-highlight/diff-highlight
```

The segment of the above path that matters is `2.28.0` as this is the version of git you are using locally.
